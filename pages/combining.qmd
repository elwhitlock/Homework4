...
Look at high-quality, reasonable alcohol value wines. Sort from high to low quality. Show only variables that contain 'acid' the **alcohol** variable, **type** variable and **quality** variable. Group by **quality** variable. Finally find the mean and median for **alcohol**
